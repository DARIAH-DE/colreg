...
<tr class="list">
	<td class="accrualMethodTable_accrualMethod" onclick="editor.accrualMethodTable.editEntry(this); return false;">
		<c:choose>
			<c:when test="${currMethod!=null}">${currMethod.accrualMethod}</c:when>
			<c:otherwise>~ New entry</c:otherwise>
		</c:choose>
	</td>
	<td class="accrualMethodTable_accrualPolicy" onclick="editor.accrualMethodTable.editEntry(this); return false;">
		<c:if test="${currMethod!=null}">${currMethod.accrualPolicy}</c:if>
	</td>
	<td class="nowrap">
